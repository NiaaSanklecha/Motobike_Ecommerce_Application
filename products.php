...
<html lang="en">
  ...
  <body>
    ...
    <header>
      ...
      <div class="section hero-section" style="background-color: #F0F0F0;">
        <div class="container">
          ...
          <?php
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo '<span class="product__price"> CAD ' . $row['motorbikePrice'] . '</span>';
                        echo '<img class="product__image" src="' . $row['motorbikeImage'] . '">';
                        echo '<h1 class="product__title">' . $row['motorbikeName'] . '</h1>';
                        echo '<hr />';
                        echo '<p>' . $row['motorbikeDescription'] . '</p>';
                        echo '<a href="detailProduct.php?motorbikeID='. $row['motorbikeID'] . '" >View Details</a>';
                        echo '<a href="cart.php" class="product__btn btn">Add To Cart</a>';
                        echo '</div>';
                    }
                    ?>
            <div class="product">
                <span class="product__price"> CAD 6229</span>
                <img class="product__image" src="images/product-2.png">
                <h1 class="product__title">Royal Enfield Classic 350</h1>
                <hr />
                <p>Classic 350 continues to embody the traditions and craftsmanship of the past as it is reborn on the new J platform. </p>
                <a href="#" class="product__btn btn">Add To Cart</a>
              </div>
              <div class="product">
                <span class="product__price">CAD 7199</span>
                <img class="product__image" src="images/product-3.png">
                <h1 class="product__title">Royal Enfield Himalayan</h1>
                <hr />
                <p>Royal Enfield Himalayan is an adventure touring motorcycle manufactured by Royal Enfield. </p>
                <a href="#" class="product__btn btn">Add To Cart</a>
              </div>
