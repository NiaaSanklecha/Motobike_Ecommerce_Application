        ...
        <div class="container">
          <div class="hero-wrapper">
            <div class="split-content hero-left">
              ...
              <h3 class=" subtitle">Our futuristic bike collection merges cutting-edge technology with sleek design, promising an unparallel ride that transcends traditional boundaries.</h3>
              <div>
                <a href="products.php" class="button-primary">Show Bikes</a>
              </div>
            </div>
            <div class="image-wrapper hero-image">
              <img
                src="images/product-2.png"
                srcset="images/product-2.png 500w, images/product-2.png 1184w"
                alt="Web Designer"
