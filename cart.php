...
<html lang="en">
  ...
  <thead>
    <tr>
      ...
      <th scope="col"  style="text-align:justify !important;">Product </th>
  ...
  <tbody>
    <tr>
      ...
      <td class="col-3" style="text-align:justify !important;"><img src="images/product-2.png" height="100" width="100"/>Product 1</td>
      <td class="col-1">CAD 10000</td>
      <td class="col-1"><div class="input-group border rounded-pill" >
  ...
  <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8"/>
                                    ...
                                    <input type="text" id="quantity" name="quantity" class="form-control input-number border-0 w-25" value="1" min="1" max="100">
                                    <span class="input-group-btn">
  ...
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
      ...
      <td class="col-1">CAD 10000</td>
      <td class="col-1"><button type="button" class="quantity-right-plus btn  btn-number p-3">
                                            <span ><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#000000" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
...
<a href="products.php" class="btn btn-dark flex-shrink-0" type="button">
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
</svg>
                                Continue Shopping
                      </a>
                            <a href="checkout.php" class="btn btn-dark flex-shrink-0" type="button">
                                
                                CheckOut
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#ffffff" class="bi bi-arrow-right" viewBox="0 0 16 16">
